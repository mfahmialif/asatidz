 ...
 <div class="flex flex-col gap-6">
        ...
        <div class="navbar-logo-preview">
         ...
         <div v-else class="text-preview text-preview-with-icon">
          ...
          <span class="preview-logo-text">
           <strong>{{ navbarTextTitle || systemName || 'Asatidz ' }}</strong>
   ...
   <div class="px-6 py-5 space-y-6">
    ...
    <div class="setting-row">
     ...
     <div class="setting-control grid gap-3 sm:grid-cols-[1fr_1fr]">
      ...
      <input v-model="emailForm.smtp_from_name" class="setting-input rounded-lg py-2.5 px-4 text-sm focus:outline-none focus:ring-1 focus:ring-accent" placeholder="Asatidz " />
     </div>
    </div>
   ...
   <div class="px-6 py-5 space-y-6">
    ...
    <div class="setting-row">
     <div class="setting-label">
      ...
      <p class="text-xs mt-0.5" style="color: var(--text-muted)">Opsional, contoh: asatidz.id. Kosongkan untuk semua domain Google</p>
     </div>
     <div class="setting-control">
      <input
       v-model="googleForm.google_hosted_domain"
       class="setting-input w-full rounded-lg py-2.5 px-4 text-sm focus:outline-none focus:ring-1 focus:ring-accent"
       placeholder="asatidz.id"
      />
     </div>
    </div>
  ...
  <div class="save-bar rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 sticky bottom-0 z-10">
   <p class="text-sm" style="color: var(--text-muted)">
    ...
    Pengaturan ini disiapkan untuk kebutuhan identitas Asatidz.
   </p>
   <button
...
const navbarTextTitle = ref('Asatidz ')
...
const googleGuideSteps = [
 {
  ...
  description: 'Buat project baru atau pilih project yang sudah dipakai untuk Asatidz.',
 },
 {
...
function fillGeneralForm(data) {
 systemName.value = data.system_name || 'Asatidz '
 ...
 navbarTextTitle.value = data.navbar_text_title || data.system_name || 'Asatidz '
