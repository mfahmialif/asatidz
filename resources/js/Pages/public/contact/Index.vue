   ...
   <div class="mx-auto grid max-w-7xl gap-10 px-5 pb-16 pt-10 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:pt-16">
    <div data-aos="fade-right">
     ...
     <h1 class="mt-6 max-w-3xl text-5xl font-black leading-[1.02] tracking-tight text-[#101418] md:text-7xl">
      Hubungi Program Studi Doktor Pendidikan Bahasa Arab.
     </h1>
  ...
  <section class="bg-white py-16">
   <div class="mx-auto max-w-7xl px-5 lg:px-8" data-aos="fade-up">
    <div class="maps-frame">
     <iframe
      title="Lokasi Program Studi Doktor Pendidikan Bahasa Arab"
      src="https://www.google.com/maps?q=Universitas%20Islam%20Internasional%20%20Pasuruan&output=embed"
      loading="lazy"
...
const contactItems = [
 { icon: 'mail', label: 'Email', value: 'dpba@asatidz.id', note: 'Untuk informasi akademik, kegiatan, kerja sama, dan layanan prodi.' },
...
function submitMessage() {
 const messages = JSON.parse(localStorage.getItem('spi-contact-messages') || '[]')
 messages.unshift({ ...form, createdAt: new Date().toISOString() })
 localStorage.setItem('spi-contact-messages', JSON.stringify(messages))
 form.name = ''
 form.email = ''
