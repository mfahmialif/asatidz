...
class AuthController extends Controller
{
 ...
 private function sendVerificationCode(User $user, string $code): void
 {
  ...
  $systemName = AppSetting::getValue('system_name', 'Prodi Doktor Pendidikan Bahasa Arab ');
 ...
 private function applyMailSettings(): void
 {
  ...
  Config::set('mail.from.name', AppSetting::getValue('smtp_from_name', AppSetting::getValue('system_name', 'Prodi Doktor Pendidikan Bahasa Arab ')));
