...
class SettingController extends Controller
{
 ...
 public function updateGeneral(Request $request)
 {
  ...
  AppSetting::setValue('navbar_text_subtitle', $data['navbar_text_subtitle'] ?: 'Prodi');
 ...
 public function email()
 {
  return response()->json([
   ...
   'smtp_from_name' => AppSetting::getValue('smtp_from_name', AppSetting::getValue('system_name', 'Asatidz')),
